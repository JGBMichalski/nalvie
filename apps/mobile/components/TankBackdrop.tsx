...
const SUNGLOW = '#7fd4e8';
const SHAFT = '#a8e6f2';
const DUNE_LIGHT = '#2e4a5c';
const DUNE = '#1a2f3f';
const DUNE_DEEP = '#0a1822';
const MOTE = '#bfeaf5';
      ...
      <Svg style={StyleSheet.absoluteFill} viewBox="0 0 100 200" preserveAspectRatio="xMidYMin slice">
        <Defs>
          ...
          <SvgLinearGradient id="tank-shaft" x1="0" y1="0" x2="0" y2="1">
            <Stop offset="0" stopColor={SHAFT} stopOpacity={0.16} />
            <Stop offset="0.55" stopColor={SHAFT} stopOpacity={0.05} />
            <Stop offset="1" stopColor={SHAFT} stopOpacity={0} />
          </SvgLinearGradient>
        </Defs>
  ...
  return (
    ...
    >
      <Svg style={StyleSheet.absoluteFill} viewBox="0 0 100 200" preserveAspectRatio="xMidYMid slice">
        ...
        <Ellipse cx={24} cy={70} rx={1.1} ry={1.1} fill={MOTE} opacity={0.5} />
        <Ellipse cx={31} cy={112} rx={0.7} ry={0.7} fill={MOTE} opacity={0.35} />
        <Ellipse cx={58} cy={58} rx={0.8} ry={0.8} fill={MOTE} opacity={0.45} />
        <Ellipse cx={72} cy={96} rx={1.2} ry={1.2} fill={MOTE} opacity={0.4} />
        <Ellipse cx={83} cy={64} rx={0.6} ry={0.6} fill={MOTE} opacity={0.3} />
        <Ellipse cx={46} cy={132} rx={0.9} ry={0.9} fill={MOTE} opacity={0.3} />
      </Svg>
    </Animated.View>
  );
}
      ...
      >
        <Defs>
          ...
          <RadialGradient id="tank-sunglow" cx="50%" cy="0%" r="75%">
            <Stop offset="0" stopColor={SUNGLOW} stopOpacity={0.22} />
            <Stop offset="0.5" stopColor={SUNGLOW} stopOpacity={0.07} />
            <Stop offset="1" stopColor={SUNGLOW} stopOpacity={0} />
          </RadialGradient>
          {/* Dunes carry the same upper-left-lit radial volume as the creatures. */}
          <RadialGradient id="tank-dune-far" cx="35%" cy="20%" r="90%">
            <Stop offset="0" stopColor={DUNE_LIGHT} stopOpacity={0.55} />
            <Stop offset="1" stopColor={DUNE} stopOpacity={0.55} />
          </RadialGradient>
          <RadialGradient id="tank-dune-near" cx="35%" cy="15%" r="95%">
            <Stop offset="0" stopColor={DUNE_LIGHT} />
            <Stop offset="0.6" stopColor={DUNE} />
            <Stop offset="1" stopColor={DUNE_DEEP} />
          </RadialGradient>
          {/* Edge vignette pulls the eye to the lit centre of the water column. */}
          <RadialGradient id="tank-vignette" cx="50%" cy="45%" r="75%">
            <Stop offset="0.6" stopColor={DUNE_DEEP} stopOpacity={0} />
            <Stop offset="1" stopColor={DUNE_DEEP} stopOpacity={0.5} />
          </RadialGradient>
        </Defs>
        ...
        <Path d="M 0 186 C 20 176, 42 182, 60 178" stroke={DUNE_LIGHT} strokeWidth={2.4} opacity={0.18} fill="none" strokeLinecap="round" />
        <Path d="M 0 186 C 20 176, 42 182, 60 178" stroke={SUNGLOW} strokeWidth={1} opacity={0.22} fill="none" strokeLinecap="round" />

        <Path d="M 0 0 H 100 V 200 H 0 Z" fill="url(#tank-vignette)" />
      </Svg>

      {AMBIENT_ANIMATION && <LightShafts />}
      {AMBIENT_ANIMATION && <Motes />}
